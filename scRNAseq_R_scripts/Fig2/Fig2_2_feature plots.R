...
ggsave(paste(gene, "TSNE.pdf", sep="_"), plot = last_plot(), device = "pdf", path = "~/Desktop/feature_plots/PDF/",
       scale = 0.6, width = 10, height = 8, units = c("in"),
       dpi = 300, limitsize = FALSE)

ggsave(paste(gene, "TSNE.png", sep="_"), plot = last_plot(), device = "png", path = "~/Desktop/feature_plots/PNG",
       scale = 0.6, width = 10, height = 8, units = c("in"),
       dpi = 300, limitsize = FALSE)
...
VlnPlot(
  ...
  use.raw=T, x.lab.rot=0, do.return=T, size.y.use = 20
) + ylab("UMI counts") + xlab("Clusters") +
...
ggsave(paste(gene, "VlnPlot.pdf", sep="_"), plot = last_plot(), device = "pdf", path = "~/Desktop/feature_plots/PDF",
