...
levels(experiment.aggregate@ident) <- c(levels(experiment.aggregate@ident), "Mac2_neg")
experiment.aggregate@ident[names(experiment.aggregate@ident) %in% cell_name] <- c("Mac2_neg")
table(experiment.aggregate@ident)

save(experiment.aggregate, file="~/desktop/PLX_Rdata/Data_RunTSNE_add_Mac2_neg.Rdata")
